...
Route::get("/contact", [\App\Http\Controllers\ContactController::class, "page"])->name("page");
...
Route::get("/404", [\App\Http\Controllers\PagesController::class,"page404"])->name("page404");
...
Route::middleware(['LoggedInPageDisallowed'])->group(function () {
    Route::get("/login",[\App\Http\Controllers\AuthenticationController::class, "loginPage"])->name("loginPage");

    ...
    <div class="adminContainer">
        ...
        <div id="deleteModal" class="messageBox ">
            ...
            <div class="messageBoxContent messageDeleteBox">
                    <ul>
                        <li><button class="closeMessageBox button closeDelete" type="button">&times;</button></li>
                        <li class="deleteBoxHeader">Da li želite da obrišete?</li>
                        <li class="deleteBothButtons"><button type="button" class="deleteButton button deleteButtonService">Da</button><button type="button" class="noDeleteButton">Ne</button></li>

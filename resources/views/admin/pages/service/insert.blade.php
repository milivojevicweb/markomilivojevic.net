        ...
        <input type="hidden" name="_token" value="{{csrf_token()}}"/>
            <ul class="contactForm adminProduct marginForm">
                ...
                <li>
                    ...
                    <button type="button" id="imageButton" onclick="document.getElementById('profilePhoto').click()" class="dugmeFile button inputForm">Dodaj sliku</button>
                ...
                <li><label>Link</label><input type="text" name="serviceLink" id="serviceLink"/></li>
                <li>
                    <select name="level">
                        @foreach ($level as $item)
                            @component("admin.partials.level",["level"=>$item])

                            @endcomponent
                        @endforeach
                    </select>
                </li>
                <li><button type="submit" disabled id="submit" class="inputForm buttonDisable button" name="addService">Potvrdi</button></li>
